...
**建议学习顺序**：先 [下载并安装](/download) → 按下面章节导入视频与字幕 → 熟悉单词标记 → 播放中查词与跨视频回顾 → 最后在「单词」页复习。每节配有演示视频（自动循环播放），文字说明帮你建立预期，具体操作以视频为准。
...
<p><strong>演示：批量导入与自动配对</strong></p>
...
字幕导入后，词有戏会**解析出字幕中的全部英文单词**，并汇总到顶部导航的 **「单词」Tab**（路径 `/word`）。这里是你管理「这一集/这一部片子里有哪些词」的主战场，和播放页里的点词操作是联动的。
...
正常看片时，字幕会高亮当前句。对句子里**任意单词**单击，即可弹出释义；更实用的是**句库联动**：软件会在你已导入的**全部本地视频**里搜索该词还出现在哪些句子，列出后**一键跳转播放**对应片段。同一个词在不同剧集、不同语境里反复出现，记忆会牢得多。

适合：刚遇到生词、想确认用法，或复习时想「再听一遍原句怎么说的」。

<p><strong>演示：点词查义与跨视频句库播放</strong></p>
...
<p><strong>演示：翻译、标记与跨视频单词查找</strong></p>
...
<p><strong>演示：单词复习与片段回顾</strong></p>
...
如果你不想在开看前先处理 Word Tab 里成百上千个红词，可以直接开始享受视频。播放过程中，软件会**在后台收集遇到的新词**；当积累到一定数量，会**弹出提示**，让你一次性选择要标记哪些词。

这样学习节奏更自然：**先沉浸看剧，再在合适时机批量处理生词**。弹窗出现的次数、阈值等可在 [设置与偏好](/guide/settings) 里按个人习惯调节。

<p><strong>演示：自动收集新词与弹窗批量标记</strong></p>
